...
if(count($_POST)>0) {
	...
	$sql = "INSERT INTO user (usertype, image, firstName, lastName, username, password, gender, email, mobile, city) VALUES ('D','" . $_POST["image"] . "','" . $_POST["fname"] . "','" . $_POST["lname"] . "','" . $_POST["username"] . "','" . $_POST["password"] . "','" . $_POST["gender"] . "','" . $_POST["email"] . "','" . $_POST["mobile"] . "','" . $_POST["city"] . "')";
